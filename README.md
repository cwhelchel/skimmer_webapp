...
the file. If not open the file and update these three things: 
...
Run the exe in the release.

## The Hard Way

Run directly from source using Python.
...
Behind the scenes, the web app will kick off a process for the normal skcc skimmer
