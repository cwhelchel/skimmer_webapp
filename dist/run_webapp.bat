...
if exist skimmerwebapp.cfg echo found skimmerwebapp.cfg && xcopy /d /y /q skimmerwebapp.cfg .\skimmer_webapp\skimmerwebapp.cfg
if exist skcc_skimmer.cfg echo found skcc_skimmer.cfg && xcopy /d /y /q skcc_skimmer.cfg .\skimmer_webapp\skcc_skimmer.cfg
